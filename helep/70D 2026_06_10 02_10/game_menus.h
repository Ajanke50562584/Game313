...
public:
    ...
    bool Is_Single_Player_Game_Current() const;
    bool Is_Multiplayer_Game_Current() const;
    Single_Player_Game_Screen *Get_Single_Player_Game_Screen() const;
    Multiplayer_Game_Screen *Get_Multiplayer_Game_Screen() const;
...
private:
    ...
    void Go_To_Story_Mode();
    void Go_To_Leaderboard();
...
private slots:
    ...
    void Select_Level_Button_Clicked();
    void Level_Select_Back_Clicked();
    void Highscores_Button_Clicked();
    void Leaderboard_Back_Clicked();
    void Go_To_Single_Player_Game();
    void Go_To_Multiplayer_Game();
...
private:
    ...
    Story_Mode_Main_Screen *Story_Mode_Main_Menu_Screen;
    Single_Player_Game_Screen *Single_Player_Game_Screen_Widget;
    Multiplayer_Game_Screen *Multiplayer_Game_Screen_Widget;
    Leaderboard_Screen *Leaderboard_Menu_Screen;
    ...
    QPushButton *Main_Menu_Highscores_Button;
    ...
    QPushButton *Level_Select_Back_Button;
    QPushButton *Leaderboard_Back_Button;
