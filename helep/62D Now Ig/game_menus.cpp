...
void Game_Menus::Attach_Networking_Elements(Game_Networking_Elements *networkingElements)
{
    ...
    connect(Game_Networking_Group, SIGNAL(Game_Start_Received()),this, SLOT(Go_To_Story_Mode_Tut()));
}
...
void Game_Menus::Setup_Navigation()
{
    ...
    //TEMP NETWORKING GO TO STORY MODE::
    connect(Game_Networking_Group, SIGNAL(Game_Start_Received()),this, SLOT(Go_To_Story_Mode_Tut()));
    connect(Game_Multiplayer_Lobby_Group, SIGNAL(Start_Game_Requested()),this, SLOT(Go_To_Story_Mode_Tut()));
...
bool Game_Menus::Is_Story_Mode_Tutorial_Current() const
{
    return Screen_Stack->currentWidget() == Story_Mode_Tutorial_Screen;
}

Story_Mode_Tutorial *Game_Menus::Get_Story_Mode_Tutorial_Screen() const
{
    return Story_Mode_Tutorial_Screen;
}
