...
void Main_Window::keyPressEvent(QKeyEvent *event)
{
    ...
    case Qt::Key_F:
        qDebug() << "Melee";
        if(Game_Menus_Group->Is_Single_Player_Game_Current())
            Game_Menus_Group->Get_Single_Player_Game_Screen()->Handle_Mouse_Button((int)Qt::LeftButton, true);
        if(Game_Menus_Group->Is_Multiplayer_Game_Current())
            Game_Menus_Group->Get_Multiplayer_Game_Screen()->Handle_Mouse_Button((int)Qt::LeftButton, true);
        break;

    case Qt::Key_R:
        qDebug() << "Ranged";
        if(Game_Menus_Group->Is_Single_Player_Game_Current())
            Game_Menus_Group->Get_Single_Player_Game_Screen()->Handle_Mouse_Button((int)Qt::RightButton, true);
        if(Game_Menus_Group->Is_Multiplayer_Game_Current())
            Game_Menus_Group->Get_Multiplayer_Game_Screen()->Handle_Mouse_Button((int)Qt::RightButton, true);
        break;
    ...
    case Qt::Key_Shift:
        if(Game_Menus_Group->Is_Single_Player_Game_Current())
            Game_Menus_Group->Get_Single_Player_Game_Screen()->Set_Run_Pressed(true);
        if(Game_Menus_Group->Is_Multiplayer_Game_Current())
            Game_Menus_Group->Get_Multiplayer_Game_Screen()->Set_Run_Pressed(true);
        break;
...
void Main_Window::keyReleaseEvent(QKeyEvent *event)
{
    ...
    case Qt::Key_F:
        qDebug() << "Melee Released";
        if(Game_Menus_Group->Is_Single_Player_Game_Current())
            Game_Menus_Group->Get_Single_Player_Game_Screen()->Handle_Mouse_Button((int)Qt::LeftButton, false);
        if(Game_Menus_Group->Is_Multiplayer_Game_Current())
            Game_Menus_Group->Get_Multiplayer_Game_Screen()->Handle_Mouse_Button((int)Qt::LeftButton, false);
        break;

    case Qt::Key_R:
        qDebug() << "Ranged Released";
        if(Game_Menus_Group->Is_Single_Player_Game_Current())
            Game_Menus_Group->Get_Single_Player_Game_Screen()->Handle_Mouse_Button((int)Qt::RightButton, false);
        if(Game_Menus_Group->Is_Multiplayer_Game_Current())
            Game_Menus_Group->Get_Multiplayer_Game_Screen()->Handle_Mouse_Button((int)Qt::RightButton, false);
        break;
    ...
    case Qt::Key_Shift:
        if(Game_Menus_Group->Is_Single_Player_Game_Current())
            Game_Menus_Group->Get_Single_Player_Game_Screen()->Set_Run_Pressed(false);
        if(Game_Menus_Group->Is_Multiplayer_Game_Current())
            Game_Menus_Group->Get_Multiplayer_Game_Screen()->Set_Run_Pressed(false);
        break;
