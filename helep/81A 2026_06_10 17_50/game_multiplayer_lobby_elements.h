...
private:
    ...
    void Tally_Difficulty_Votes();
    void Rebuild_Player_Circles();
...
private slots:
    ...
    void Handle_Easy_Difficulty();
    void Handle_Medium_Difficulty();
    void Handle_Hard_Difficulty();
    void Handle_Apply_Lobby_Settings();
...
private:
    ...
    // difficulty popout
    QWidget *Difficulty_Popup;
    QLabel *Difficulty_Title_Label;
    QLabel *Difficulty_Current_Label;
    QPushButton *Easy_Difficulty_Button;
    QPushButton *Medium_Difficulty_Button;
    QPushButton *Hard_Difficulty_Button;
    QLabel *Easy_Map_Preview_Label;
    QLabel *Medium_Map_Preview_Label;
    QLabel *Hard_Map_Preview_Label;

    // lobby settings popout
    QWidget *Lobby_Settings_Popup;
    QCheckBox *Lobby_Public_Checkbox;
    QLineEdit *Lobby_Password_Input;
    QSpinBox *Lobby_Max_Players_Input;
    QPushButton *Apply_Lobby_Settings_Button;

    QList<QLabel*> Player_Circle_Labels;
    QWidget *Player_Circle_Holder;
    int Easy_Votes;
    int Medium_Votes;
    int Hard_Votes;
