...
Game_Multiplayer_Lobby_Elements::Game_Multiplayer_Lobby_Elements(QWidget *parent) // Constructor definition
    : QObject(parent) // call base constructor first i.e q object
{
