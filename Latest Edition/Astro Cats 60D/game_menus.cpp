    ...
    : QObject(parent)
{
    ...
    Story_Mode_Tutorial_Screen = new Story_Mode_Tutorial(Screen_Stack); // OpenGL story tutorial screen
    ...
    Screen_Stack->addWidget(Story_Mode_Tutorial_Screen); // add OpenGL tutorial to stack
...
void Game_Menus::Setup_Navigation()
{
    ...
    connect(Multiplayer_Menu_Screen, SIGNAL(Back_Button_Clicked()), this, SLOT(Multiplayer_Back_Button_Clicked()));
    connect(Multiplayer_Menu_Screen, SIGNAL(Host_Button_Clicked()), this, SLOT(Multiplayer_Host_Button_Clicked()));
    connect(Multiplayer_Menu_Screen, SIGNAL(Client_Button_Clicked()), this, SLOT(Multiplayer_Client_Button_Clicked()));
    ...
    connect(Join_Server_Menu_Screen, SIGNAL(Join_Button_Clicked(int,QString)), this, SLOT(Join_Server_Join_Button_Clicked(int,QString)));
    connect(Join_Server_Menu_Screen, SIGNAL(Refresh_Button_Clicked()), this, SLOT(Join_Server_Refresh_Button_Clicked()));
    connect(Join_Server_Menu_Screen, SIGNAL(Back_Button_Clicked()), this, SLOT(Join_Server_Back_Button_Clicked()));
...
void Game_Menus::Go_To_Story_Mode_Tut()
{
    Screen_Stack->setCurrentWidget(Story_Mode_Tutorial_Screen);
    Story_Mode_Tutorial_Screen->setFocus(Qt::OtherFocusReason);
}
...
void Game_Menus::Join_Game(int selectedRow, const QString &playerName)
{
    if(Shared_Group == nullptr || Game_Networking_Group == nullptr || Game_Multiplayer_Lobby_Group == nullptr)
    {
        qDebug() << "Missing groups";
    ...
    QString Player_Name = playerName.trimmed();
...
void Game_Menus::Join_Server_Join_Button_Clicked(int selectedRow, QString playerName)
{
    Join_Game(selectedRow, playerName);
}
...
void Game_Menus::Join_Server_Refresh_Button_Clicked()
{
    ...
    Join_Server_Menu_Screen->Set_Lobby_List(QStringList());
...
void Game_Menus::Refresh_Discovered_Lobbies()
{
    ...
    for(int i = 0; i < Lobbies.size(); i++)
    {
        ...
        Lobby_Texts.append(Lobby_Text);
    }

    Join_Server_Menu_Screen->Set_Lobby_List(Lobby_Texts);
}
