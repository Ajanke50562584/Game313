    ...
    : QWidget(parent)
{
    ...
    // No animation loops have finished yet
    Completed_Animation_Loops = 0;

    // The animation status has not been printed/reported yet
    ...
    qDebug() << test.isNull()<< "Image found status";
    ...
    {
        Frames.append(Sprite_Sheet->copy(x, 0, frameWidth, frameHeight)); // Add each frame of the sprite sheet into memory
    }
