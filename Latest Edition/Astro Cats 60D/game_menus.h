...
private:
    ...
    void Start_Hosting();
    void Join_Game(int selectedRow, const QString &playerName);
...
private slots:
    ...
    void Join_Server_Join_Button_Clicked(int selectedRow, QString playerName);
...
private:
    ...
    Story_Mode_Tutorial *Story_Mode_Tutorial_Screen;
