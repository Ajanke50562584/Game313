...
void Game_Menus::Build_Screens(QWidget *parent)
{
    ...
    Story_Mode_Main_Menu_Screen = new Story_Mode_Main_Screen(Screen_Stack);
    Story_Mode_Tut_Screen = new Single_Player_Tutorial_Scene(Screen_Stack);
    Story_Mode_Tutorial_Screen = new Story_Mode_Tutorial(Screen_Stack);
    ...
    Screen_Stack->addWidget(Story_Mode_Main_Menu_Screen);
    Screen_Stack->addWidget(Story_Mode_Tut_Screen);
    Screen_Stack->addWidget(Story_Mode_Tutorial_Screen);
...
void Game_Menus::Attach_Multiplayer_Lobby_Elements(Game_Multiplayer_Lobby_Elements *lobbyElements)
{
    ...
    if(Game_Multiplayer_Lobby_Group != nullptr)
    {
        ...
        connect(Game_Multiplayer_Lobby_Group, &Game_Multiplayer_Lobby_Elements::Leave_Lobby_Requested,
                this, &Game_Menus::Go_To_Multiplayer_Menu, Qt::UniqueConnection);
    }
}
...
QWidget *Game_Menus::Get_Root_Widget() const
{
    return Screen_Stack;
}
