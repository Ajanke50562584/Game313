...
{
    //fisika
    const float Standing_Width = STORY_MODE_PLAYER_WORLD_SIZE * 0.55f;
    const float Standing_Height = STORY_MODE_PLAYER_WORLD_SIZE * 0.85f;
    const float Crouch_Height = STORY_MODE_PLAYER_WORLD_SIZE * 0.55f;
    const float Old_Bottom = Player_Physics_Body.Get_Bottom();
    const bool Wants_To_Crouch = Move_Crouch_Pressed == true;
