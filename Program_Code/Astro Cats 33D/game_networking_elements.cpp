...
bool Game_Networking_Elements::Start_Listening()
{
    ...
    {
        Shared_Group->Set_Connection_Status(Listen_Was_Started ? "Listening on port 30033" : "Failed to bind port 30033");
        Shared_Group->Set_Remote_Address(Listen_Was_Started ? "0.0.0.0:30033" : "Not connected");
        Shared_Group->Set_Last_Network_Event(Listen_Was_Started ? "Socket bound and listening" : "Bind failed");
    }
