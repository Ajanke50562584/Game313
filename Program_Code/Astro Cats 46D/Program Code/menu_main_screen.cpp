    ...
    , Animation_Status_Reported(false)
{
    ...
    QPixmap test(":/Images/Background/Graphic Resources/Static Graphic Resources/Backgrounds/Space_BG_1.png");
    qDebug() << test.isNull();


    // cut the sprite sheet into frames
    Sprite_Sheet = new QPixmap(":/Images/Characters/Graphic Resources/Animated Graphic Resources/Spritesheets/Awake_Laying_Orange.png");
    ...
    setStyleSheet(
        "#MainMenu {"
        "border-image: url(:/Images/Background/Graphic Resources/Static Graphic Resources/Backgrounds/Space_BG_1.png) 0 0 0 0 stretch stretch;"
        "}"
    );
    ...
    // shared button sizing and visual setup
