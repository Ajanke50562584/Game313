...
void Game_Multiplayer_Lobby_Elements::Apply_Responsive_Sizing()
{
    ...
    Chat_Display->setFont(Body_Font);
    Chat_Input->setFont(Body_Font);
    ...
    const int Action_Button_Width = qMax(110, (170 * w) / 1280);
    const int Wide_Action_Button_Width = qMax(160, (240 * w) / 1280);
